        ...
        <div class="flex-1 ml-72 mt-20 p-8">
            ...
            <div class="mt-4">
                ...
                <ul class="inline-flex items-center">
                    ...
                    <?php if ($page > 1): ?>
                        <li>
                            <a href="?modul=category&fitur=list&page=<?= $page - 1 ?>&search=<?= urlencode($search) ?>" 
                    ...
                    <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                        <li>
                            <a href="?modul=category&fitur=list&page=<?= $i ?>&search=<?= urlencode($search) ?>" 
                            class="px-3 py-2 <?= ($i == $page) ? 'bg-blue-500 text-white' : 'bg-gray-200 hover:bg-gray-300' ?> rounded">
                            <?= $i ?>
                            </a>
                        </li>
                    <?php endfor; ?>
