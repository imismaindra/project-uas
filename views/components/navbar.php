...
<nav class="bg-[#1A1B41] border-gray-200 shadow shadow-md">
  ...
  <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
    <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-[#1A1B41]">
      <li>
        <a href="#" class="block py-2 px-3 md:p-0 text-white bg-[#63BF5F] rounded md:bg-transparent md:text-[#63BF5F] " aria-current="page">Top-up</a>
      </li>
      <li>
